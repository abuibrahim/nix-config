    ...
    profiles.default = {
      userSettings = {
        ...
        "nix.serverSettings.nixd.options.nixos.expr" =
          "(builtins.getFlake (toString ./.)).nixosConfigurations.t25.options";
        "nix.serverSettings.nixd.options.home-manager.expr" =
          "(builtins.getFlake (toString ./.)).nixosConfigurations.t25.options.home-manager.users.type.getSubOptions []";
      };
